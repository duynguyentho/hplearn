                                    ...
                                    <div class="mt-4">
                                        <form class="form-horizontal" method="POST" action="{{ route('admin.login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="username" type="text" class="form-control @error('username') is-invalid @enderror" value="{{ old('username', 'admin') }}" id="username" placeholder="Enter username" autocomplete="username" autofocus>
                                                @error('username')
